...
import PwChangeSuccessScreen from './pwChangeSuccess'; // Adjust the path if needed
import { FontAwesome } from '@expo/vector-icons';

export default function NewPWScreen({navigation}: {navigation: any}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={[styles.resetButton, { opacity: isPasswordMatching ? 1 : 0.5 }]} // Enable only when passwords match
        disabled={!isPasswordMatching}
        onPress={() => navigation.navigate('PwChangeSuccessScreen')} // Replace with your reset logic
      >
